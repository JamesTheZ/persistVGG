...
N, H, W, CO, CI, KH, KW, strides, padding = 1, 112, 112, 128, 128, 3, 3, (1, 1), (1, 1)
...
# log kernel to .cu file
cufile = open("best_conv.cu", "w")
print(func.imported_modules[0].get_source(), file = cufile)
cufile.close()
